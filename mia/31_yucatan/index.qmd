...
::: grid-item
```{r hotspots_cases_ticul, out.height="110%", out.width="110%"}
load("~/Library/CloudStorage/Dropbox/hotspots_2022/8.RData/cases_hotspots_agebs19.RData")
library(magrittr)
cases_hotspots_agebs19 |>
    sf::st_make_valid() |>
...
::: grid-item
```{r hotspots_vector_ticul, out.height="110%", out.width="110%"}
source("~/Library/CloudStorage/Dropbox/r_developments/r_talks/2023/reunion_interstatal_2023/reunion_quintana_roo/functions/intensity_eggs.R")
load("~/Library/CloudStorage/OneDrive-Personal/proyects/hotspots_eggs/8.RData/31_yucatan/betas/31_yucatan_zinb1_betas.RData")
betas_31_yucatan |>
    dplyr::filter(year == 2019) |>
    intensity_eggs(locality = "Ticul",
                    cve_ent = "31",
                    palette = rcartocolor::carto_pal,
                    name = "SunsetDark")
```
...
::: grid-item
```{r risk_ticul, out.height="110%", out.width="110%"}
# load the dengue cases hotspots
load("~/Library/CloudStorage/Dropbox/hotspots_2022/8.RData/cases_hotspots_agebs19.RData")
hotspots <- cases_hotspots_agebs19 |>
    sf::st_make_valid()
...
::: grid-item
```{r hotspots_cases_tizimin, error=FALSE,out.height="110%", out.width="100%"}
load("~/Library/CloudStorage/Dropbox/hotspots_2022/8.RData/cases_hotspots_agebs19.RData")
library(magrittr)
cases_hotspots_agebs19 |>
    sf::st_make_valid() |>
    dplyr::filter(loc == "Tizimín") |>
denhotspots::staticmap_intensity(pal = rcartocolor::carto_pal,
                                 pal_name = TRUE,
                                 name = "OrYel",
                                 breaks = 1,
...
::: grid-item
```{r hotspots_vector_tizimin, error=FALSE, out.height="110%", out.width="110%"}
source("~/Library/CloudStorage/Dropbox/r_developments/r_talks/2023/reunion_interstatal_2023/reunion_quintana_roo/functions/intensity_eggs.R")
load("~/Library/CloudStorage/OneDrive-Personal/proyects/hotspots_eggs/8.RData/31_yucatan/betas/31_yucatan_zinb1_betas.RData")
betas_31_yucatan |>
    dplyr::filter(year == 2019) |>
    intensity_eggs(locality = "tizimim",
                    cve_ent = "31",
                    palette = rcartocolor::carto_pal,
                    name = "SunsetDark")
```
...
::: grid-item
```{r risk_tizimin, out.height="110%", out.width="110%"}
# load the dengue cases hotspots
load("~/Library/CloudStorage/Dropbox/hotspots_2022/8.RData/cases_hotspots_agebs19.RData")
hotspots <- cases_hotspots_agebs19 |>
    sf::st_make_valid()
...
a <- risk_transmision_activa(betas = merida$betas,
                        ...
                        locality = "Merida") +
  ggplot2::ggtitle("Merida")
b <- risk_transmision_activa(betas = kanasin$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Kanasin") +
  ggplot2::ggtitle("Kanasin")
...
```{r risk_escenario_actual_uman, out.height="100%", out.width="100%"}
if(as.vector(Sys.info()["sysname"]) == "Darwin"){
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2023/9.geocoded_dataset/dengue_mx_2023.RData")
...
# Step 1.3. knox test
library(magrittr)
knox_res <- denhotspots::knox(x = y[loc,], 
                               crs = "+proj=eqc", 
                               ds = 400, 
                               dt = 20, 
                               sym = 1000, 
...
a <- risk_transmision_activa(betas = valladolid$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Valladolid") +
  ggplot2::ggtitle("Valladolid")
...
```{r risk_escenario_actual_piste, out.height="100%", out.width="100%"}
if(as.vector(Sys.info()["sysname"]) == "Darwin"){
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2023/9.geocoded_dataset/dengue_mx_2023.RData")
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/talks/reunion_inter_estatal/8.RData/eggs_hotspots_2023.RData")
    source("~/Library/CloudStorage/Dropbox/r_developments/r_talks/2023/reunion_interstatal_2023/reunion_quintana_roo/functions/risk_transmission_activa.R")
...
a <- risk_transmision_activa(betas = piste$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Pisté") +
  ggplot2::ggtitle("Piste")
...
b <- denhotspots::space_time_link_map(x = knox_res,
                                 locality = "Izamal",
                                 cve_edo = "31",
                                 maptype = "staticmap",
                                 facetmap = FALSE) +
  ggplot2::ggtitle("Izamal")
...
```{r risk_escenario_actual3, out.height="100%", out.width="100%"}
if(as.vector(Sys.info()["sysname"]) == "Darwin"){
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2023/9.geocoded_dataset/dengue_mx_2023.RData")
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/talks/reunion_inter_estatal/8.RData/eggs_hotspots_2023.RData")
    source("~/Library/CloudStorage/Dropbox/r_developments/r_talks/2023/reunion_interstatal_2023/reunion_quintana_roo/functions/risk_transmission_activa.R")
...
a <- risk_transmision_activa(betas = tekax$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Tekax de Alvaro Obregon") +
  ggplot2::ggtitle("Tekax")
b <- risk_transmision_activa(betas = peto$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Peto") +
  ggplot2::ggtitle("Peto")
...
```{r risk_escenario_actual4, out.height="100%", out.width="100%"}
if(as.vector(Sys.info()["sysname"]) == "Darwin"){
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/geocoding_mex/2023/9.geocoded_dataset/dengue_mx_2023.RData")
    load("~/Library/CloudStorage/OneDrive-Personal/proyects/talks/reunion_inter_estatal/8.RData/eggs_hotspots_2023.RData")
    source("~/Library/CloudStorage/Dropbox/r_developments/r_talks/2023/reunion_interstatal_2023/reunion_quintana_roo/functions/risk_transmission_activa.R")
...
a <- risk_transmision_activa(betas = oxkutzcab$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Oxkutzcab") +
  ggplot2::ggtitle("Oxkutzcab")
b <- risk_transmision_activa(betas = ticul$betas,
                        geocoded_data =  z,
                        cve_edo = "31",
                        locality = "Ticul") +
  ggplot2::ggtitle("Ticul")
...
-   ***slides***: https://famous-puppy-8cffd3.netlify.app/mia/31_yucatan/#/
